...
\hypersetup{
    ...
    pdftitle={Algorithm Substitution Attacks},    % title: CHANGE THIS TEXT!
    pdfauthor={Philip Hodges},    % author: CHANGE THIS TEXT! and uncomment this line
    pdfsubject={Algorithm Substitution Attacks},  % subject: CHANGE THIS TEXT! and uncomment this line
...
\input{sections/statereset.tex}
\input{sections/asymASA.tex}
\input{sections/asymASA2.tex}
\input{sections/generalize.tex}
